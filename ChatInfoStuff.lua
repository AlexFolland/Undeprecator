if GetRegisteredAddonMessagePrefixes == nil then
	GetRegisteredAddonMessagePrefixes = C_ChatInfo.GetRegisteredAddonMessagePrefixes
end

if IsAddonMessagePrefixRegistered == nil then
